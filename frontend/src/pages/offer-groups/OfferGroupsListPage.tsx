...
type OfferGroupsTab = "others" | "mine";
...
function OfferGroupsListPage() {
  ...
  const tab: OfferGroupsTab = isOfferGroupsTab(rawTab) ? rawTab : "others";
  ...
  return (
    <Box maxWidth={1200} mx="auto">
      <Box display="flex" justifyContent="space-between" alignItems="flex-start" gap={2} mb={3} flexWrap="wrap">
        ...
        <Button variant="contained" startIcon={<AddIcon />} component={RouterLink} to="/offer-groups/create">
          Создать группу
        </Button>
      </Box>
