// Code generated by "enumer -type=ItemType -json -text -sql -transform=lower -trimprefix=ItemType"; DO NOT EDIT.
...
const _ItemTypeName = "goodservice"

var _ItemTypeIndex = [...]uint8{0, 4, 11}

const _ItemTypeLowerName = "goodservice"
...
var _ItemTypeNameToValueMap = map[string]ItemType{
	_ItemTypeName[0:4]:       ItemTypeGood,
	_ItemTypeLowerName[0:4]:  ItemTypeGood,
	_ItemTypeName[4:11]:      ItemTypeService,
	_ItemTypeLowerName[4:11]: ItemTypeService,
}
